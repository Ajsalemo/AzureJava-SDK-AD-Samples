...
This sample uses the Azure Java SDK with [`DefaultAzureCredential`](https://docs.microsoft.com/en-us/azure/developer/java/sdk/identity-azure-hosted-auth#default-azure-credential) to create a Resource Group.
...
- Run `java -jar target/create-resource-group-1.0-SNAPSHOT-jar-with-dependencies.jar` to run the sample.