...
This sample uses the Azure Java SDK with [`DefaultAzureCredential`](https://docs.microsoft.com/en-us/azure/developer/java/sdk/identity-azure-hosted-auth#default-azure-credential) to list Storage Containers.
...
- Run `java -jar target/list-storage-containers-1.0-SNAPSHOT-jar-with-dependencies.jar` to run the sample.