...
This sample uses the Azure Java SDK with [`DefaultAzureCredential`](https://docs.microsoft.com/en-us/azure/developer/java/sdk/identity-azure-hosted-auth#default-azure-credential) to delete a Storage Container.
...
- Run `java -jar target/delete-storage-container-1.0-SNAPSHOT-jar-with-dependencies.jar` to run the sample.