...
This sample uses the Azure Java SDK with [`DefaultAzureCredential`](https://docs.microsoft.com/en-us/azure/developer/java/sdk/identity-azure-hosted-auth#default-azure-credential) to create a Blob Container.
...
- Run `java -jar target/create-blob-container-1.0-SNAPSHOT-jar-with-dependencies.jar` to run the sample.